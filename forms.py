...
class SkyscraperForm(FlaskForm):
    ...
    # schematic 元数据字段
    schematic_name = StringField('投影名称', validators=[Optional()], default='skyscraper')
    schematic_author = StringField('作者', validators=[Optional()], default='webui')
    schematic_description = StringField('描述', validators=[Optional()], default='Generated by UI')
